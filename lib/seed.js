// ============================================
// THITRONIK Seed Data (Content Migration V14)
...
export function initializeSeedData(API) {
  if (typeof window !== 'undefined') {
    // Versions-Key hochgesetzt (V14)
    const initialized = localStorage.getItem('th__initialized_v14');
    ...
    if (!initialized) {
      ...
      localStorage.setItem('th__initialized_v14', 'true');
    }
  }
}
