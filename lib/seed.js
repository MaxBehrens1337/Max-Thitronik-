// ============================================
// THITRONIK Seed Data (Content Migration V15)
...
export const seedCourses = [
  { 
    id: 'c1', title: 'Allgemeine Fragen', slug: 'allgemeinefragen', status: 'published', sortOrder: 1, icon: '📋', questionCount: 4, hasVideo: false, hasImages: true,
  ...
  { 
    id: 'c5', title: 'Funkzubehör Anlernen', slug: 'funkzubehoer', status: 'published', sortOrder: 6, icon: '📡', questionCount: 5, hasVideo: true, hasImages: true,
  ...
  { 
    id: 'c7', title: 'Grundlagen', slug: 'grundlagen', status: 'published', sortOrder: 7, icon: '📚', questionCount: 5, hasVideo: true, hasImages: true,
  ...
  { 
    id: 'c9', title: 'Magnet & Montageadapter', slug: 'magnet-montageadapter', status: 'published', sortOrder: 9, icon: '🧲', questionCount: 5, hasVideo: true, hasImages: true,
  ...
  // Pilot 6: Pro-finder
  { 
    id: 'c11', title: 'Pro-finder', slug: 'pro-finder', status: 'published', sortOrder: 11, icon: '📍', questionCount: 5, hasVideo: true, hasImages: true,
  ...
  // Pilot 7: WiPro
  { 
    id: 'c13', title: 'WiPro', slug: 'wipro', status: 'published', sortOrder: 13, icon: '🛡️', questionCount: 5, hasVideo: true, hasImages: true,
  ...
  { 
    id: 'c10', title: 'Mercedes Sprinter VS30', slug: 'mb-sprinter-vs30', status: 'published', sortOrder: 10, icon: '🚐', questionCount: 12, hasVideo: false, hasImages: true,
...
export function initializeSeedData(API) {
  if (typeof window !== 'undefined') {
    // Versions-Key hochgesetzt (V15 – Mercedes Sprinter VS30 hinzugefügt)
    const initialized = localStorage.getItem('th__initialized_v15');
    ...
    if (!initialized) {
      ...
      localStorage.setItem('th__initialized_v15', 'true');
    }
  }
}
